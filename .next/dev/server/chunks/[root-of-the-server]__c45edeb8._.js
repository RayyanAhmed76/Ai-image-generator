...
const stripe = process.env.STRIPE_SECRET_KEY && process.env.STRIPE_SECRET_KEY.length > 0 ? new __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$flux$2d$saas$2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](process.env.STRIPE_SECRET_KEY, {
...
async function GET(req) {
    try {
        ...
        try {
            lastPayment = await __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$flux$2d$saas$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].payment.findFirst({
                where: {
                    userId: user.id
                },
                orderBy: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c45edeb8._.js.map