...
"[project]/my-flux-saas/app/api/generate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (image) {
            ...
            if (!user.isSubscribed) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$flux$2d$saas$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].usage.create({
                    data: {
                        userId: user.id,
                        prompt
                    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4a8d1bc5._.js.map