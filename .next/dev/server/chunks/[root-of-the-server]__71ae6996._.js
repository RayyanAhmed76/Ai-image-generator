...
"[project]/app/api/fetch_result/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (status.includes("ready") || status.includes("succeeded") || status.includes("completed")) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ready: true,
                imageUrl: null,
                raw: json
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71ae6996._.js.map