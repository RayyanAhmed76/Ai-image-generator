...
"[project]/app/api/verify-session/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const stripe = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](stripeSecret);
        ...
        if (session.payment_status === "paid" && session.status === "complete") {
            ...
            if (!existingPayment) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].payment.create({
                    data: {
                        userId: user.id,
                        stripeSessionId: sessionId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a3935c3._.js.map